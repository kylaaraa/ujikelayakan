...
@section('content')
    ...
    <h1>Data klasifikasi TU</h1>
    <a href="{{ route('data-klasifikasi-surat.create') }}" class="btn btn-primary">Tambah</a>
        ...
        @foreach ($surat as $item)
            <tbody>
                <tr>
                    ...
                    <td>
                        <a href="{{ route('data-klasifikasi-surat.edit', $item['id']) }}" class="btn btn-warning">Edit</a>
